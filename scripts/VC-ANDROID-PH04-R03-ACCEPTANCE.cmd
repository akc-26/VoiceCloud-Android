...
cd /d "%~dp0.."
echo =============================================================
echo VoiceCloud Android PH04 R03 - Full Acceptance
echo Communities, Events, Messaging and Notifications
echo Parent: PH03-R02 3665f606e43c677d7d2e4652e2a6451d3fe459a4
echo R03: healthy-device isolated instrumentation gate
echo Preservation policy: PH01-PH03 regressions run before Android build gates
echo =============================================================
...
:device_done
echo [PASS] VC-ANDROID-PH04-R03 acceptance commands completed successfully.
