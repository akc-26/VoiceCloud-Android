...
cd /d "%~dp0.."
echo =============================================================
echo VoiceCloud Android PH02 R05 - Full Acceptance
...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\VC-ANDROID-PH02-R05-SOURCE-CHECK.ps1 || exit /b 1
...
:device_done
echo [PASS] VC-ANDROID-PH02-R05 acceptance commands completed successfully.
