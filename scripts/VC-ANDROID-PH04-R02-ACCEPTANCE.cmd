...
cd /d "%~dp0.."
echo =============================================================
echo VoiceCloud Android PH04 R02 - Full Acceptance
...
echo [WARN] No authorized adb device/emulator detected. Run :app:connectedDebugAndroidTest before PH04 manual approval.
:device_done
echo [PASS] VC-ANDROID-PH04-R02 acceptance commands completed successfully.
