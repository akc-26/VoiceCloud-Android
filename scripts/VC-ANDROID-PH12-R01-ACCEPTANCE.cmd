...
cd /d "%~dp0.."
echo =============================================================
echo VoiceCloud Android PH12 R01 - Full Acceptance
echo Creator Audience + Messaging + Followers + Subscribers
echo Parent Git baseline: VC-ANDROID-PH11-R02 @ fad14e236a780cbe14a74a4676a3ad94237d9bbe
echo =============================================================
...
python scripts\ph12_r01_acceptance_wiring_regression.py || exit /b 1
python scripts\ph12_r01_unit_contract_regression.py || exit /b 1
python scripts\ph12_r01_source_check.py || exit /b 1
...
python scripts\ph12_r01_preservation_regression.py || exit /b 1
...
python scripts\ph12_r01_package_hygiene.py || exit /b 1
echo [PASS] VC-ANDROID-PH12-R01 acceptance commands completed successfully.
