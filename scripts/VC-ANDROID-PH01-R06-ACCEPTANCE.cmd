...
cd /d "%~dp0.."
echo =============================================================
echo VoiceCloud Android PH01 R06 - Full Acceptance
echo =============================================================
where powershell >nul 2>nul || (echo [FAIL] PowerShell is required for source-contract verification.& exit /b 1)
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\VC-ANDROID-PH01-R06-SOURCE-CHECK.ps1 || exit /b 1
where python >nul 2>nul && (python scripts\ph01_r06_source_check.py || exit /b 1)
...
where python >nul 2>nul && (python scripts\ph01_r06_device_network_regression.py || exit /b 1)
...
:device_done
echo [PASS] VC-ANDROID-PH01-R06 acceptance commands completed successfully.
