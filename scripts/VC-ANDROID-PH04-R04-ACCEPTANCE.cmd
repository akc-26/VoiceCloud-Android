...
cd /d "%~dp0.."
echo =============================================================
echo VoiceCloud Android PH04 R04 - Full Acceptance
echo Communities, Events, Messaging and Notifications
echo Parent: PH03-R02 3665f606e43c677d7d2e4652e2a6451d3fe459a4
echo R04: professional UI system correction + retained healthy-device gate
echo Preservation policy: PH01-PH04-R03 regressions run before Android build gates
echo =============================================================

where powershell >nul 2>nul || (echo [FAIL] PowerShell is required for source-contract verification.& exit /b 1)
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\VC-ANDROID-PH04-R01-SOURCE-CHECK.ps1 || exit /b 1
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\VC-ANDROID-PH04-R02-SOURCE-CHECK.ps1 || exit /b 1
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\VC-ANDROID-PH04-R03-SOURCE-CHECK.ps1 || exit /b 1
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\VC-ANDROID-PH04-R04-SOURCE-CHECK.ps1 || exit /b 1
...
:device_done
echo [PASS] VC-ANDROID-PH04-R04 acceptance commands completed successfully.
