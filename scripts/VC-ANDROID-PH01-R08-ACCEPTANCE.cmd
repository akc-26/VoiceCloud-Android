...
cd /d "%~dp0.."
echo =============================================================
echo VoiceCloud Android PH01 R08 - Full Acceptance
...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\VC-ANDROID-PH01-R08-SOURCE-CHECK.ps1 || exit /b 1
where python >nul 2>nul && (python scripts\ph01_r08_source_check.py || exit /b 1)
...
:device_done
echo [PASS] VC-ANDROID-PH01-R08 acceptance commands completed successfully.
