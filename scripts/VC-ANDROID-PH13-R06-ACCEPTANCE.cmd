...
echo =============================================================
echo VoiceCloud Android PH13 R06 - Premium UI/UX Acceptance
echo Parent package: VC-ANDROID-PH13-R05
echo Scope: R05 UI/UX preserved; acceptance-harness correction only
echo =============================================================
...
if errorlevel 1 (
  ...
  if errorlevel 1 (
    ...
    powershell -NoProfile -ExecutionPolicy Bypass -File scripts\VC-ANDROID-PH13-R06-SOURCE-DIAGNOSTIC.ps1
...
if errorlevel 1 (
  ...
  powershell -NoProfile -ExecutionPolicy Bypass -File scripts\VC-ANDROID-PH13-R06-ISOLATED-BUILD.ps1
  if errorlevel 1 set /a VC_FAILURE_GROUPS+=1
)
...
if errorlevel 1 (
  ...
  python scripts\ph13_r06_delivery_integrity.py
  if errorlevel 1 set /a VC_FAILURE_GROUPS+=1
)

echo =============================================================
if not "%VC_FAILURE_GROUPS%"=="0" (
  echo [FAIL] VC-ANDROID-PH13-R06 acceptance completed with %VC_FAILURE_GROUPS% failing group^(s^).
  echo [INFO] All independent applicable gates were attempted; review every failure above.
  exit /b 1
)
echo [PASS] VC-ANDROID-PH13-R06 acceptance commands completed successfully.
exit /b 0
