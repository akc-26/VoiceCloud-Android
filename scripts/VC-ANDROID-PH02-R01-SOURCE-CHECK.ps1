...
P 'PH02 version marker retained' $app.Contains('versionName = "1.0.0-ph02"')
...
P 'later product feature modules not pulled into PH02' (-not ($settings -match ':feature:(home|rooms|wallet|messages|rtc|communities)'))
