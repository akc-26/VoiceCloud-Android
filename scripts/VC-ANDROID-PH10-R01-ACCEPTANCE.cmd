...
cd /d "%~dp0.."
echo =============================================================
echo VoiceCloud Android PH10 R01 - Full Acceptance
echo Creator Portal Core + Dashboard + Profile + Settings + Support
echo Parent Git baseline: VC-ANDROID-PH09-R08 @ 10e820a005d363643bcfc5568e661de96a41dbc9
echo =============================================================
...
python scripts\ph10_r01_acceptance_wiring_regression.py || exit /b 1
python scripts\ph10_r01_source_check.py || exit /b 1
python scripts\ph10_r01_portal_authority_regression.py || exit /b 1
python scripts\ph10_r01_compile_surface_regression.py || exit /b 1
python scripts\ph10_r01_compile_risk_regression.py || exit /b 1
python scripts\ph10_r01_preservation_regression.py || exit /b 1
rem Retained PH09-R08 regression authority that remains valid under the PH10 version bump.
...
echo [PASS] VC-ANDROID-PH10-R01 acceptance commands completed successfully.
