...
$pythonChecks = @(
 'ph13_r17_acceptance_wiring_regression.py',
 'ph13_r17_product_preservation_regression.py',
 'ph13_r17_compiler_locale_closure_regression.py',
 'ph13_r17_compile_surface_regression.py',
 'ph13_r16_design_fidelity_regression.py',
 'ph13_r17_windows_harness_structure_regression.py',
 'ph13_r17_source_hygiene.py',
 'ph13_r17_workstation_artifact_regression.py',
...
Write-Host '[SOURCE SUMMARY] R17 consolidated compiler/UTF-8 closure plus approved R16 design, functional, security, payment, RTC and workstation-safe authority checks passed.'
exit 0
