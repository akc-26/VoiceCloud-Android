...
cd /d "%~dp0.."
echo =============================================================
echo VoiceCloud Android PH08 R02 - Full Acceptance
echo PH08 corrective integration + launch-selectable payments
echo Parent Git baseline: VC-ANDROID-PH07-R03 @ fe2e7857802861e2ace2733a313c00c5d27d331d
echo =============================================================
where python >nul 2>nul || (echo [FAIL] Python is required.& exit /b 1)
python scripts\ph08_r02_source_check.py || exit /b 1
python scripts\ph08_r02_product_quality_regression.py || exit /b 1
python scripts\ph08_r02_payment_regression.py || exit /b 1
python scripts\ph08_r02_preservation_regression.py || exit /b 1
python scripts\ph08_r02_compile_risk_regression.py || exit /b 1
python scripts\ph08_r01_compile_risk_regression.py || exit /b 1
...
echo [PASS] VC-ANDROID-PH08-R02 acceptance commands completed successfully.
