...
cd /d "%~dp0.."
echo =============================================================
echo VoiceCloud Android PH13 R02 - Full Acceptance
echo Gate 8 post-build source-integrity correction
echo Product source: unchanged from PH13-R01
echo =============================================================
...
python scripts\ph13_r02_acceptance_wiring_regression.py || exit /b 1
python scripts\ph13_r02_corrective_regression.py || exit /b 1
python scripts\ph13_r02_preservation_regression.py || exit /b 1
rem PH13 product authority is unchanged from R01; replay all R01 PH13 source/contract gates.
...
echo [GATE 8] Restore bootstrap-mutated tracked source
python scripts\ph13_r02_restore_tracked_source.py || exit /b 1
echo [GATE 8] Post-build tracked-source integrity
python scripts\ph13_r02_post_build_hygiene.py || exit /b 1
echo [PASS] VC-ANDROID-PH13-R02 acceptance commands completed successfully.
