...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\VC-ANDROID-PH01-R05-SOURCE-CHECK.ps1 || exit /b 1
where python >nul 2>nul && (python scripts\ph01_r05_source_check.py || exit /b 1)
