...
$pythonChecks = @(
 'ph13_r20_acceptance_wiring_regression.py',
 'ph13_r20_product_preservation_regression.py',
 'ph13_r20_ui_root_cause_regression.py',
 ...
 'ph13_r20_windows_harness_structure_regression.py',
 'ph13_r20_source_hygiene.py',
 'ph13_r20_workstation_artifact_regression.py',
...
Write-Host '[SOURCE SUMMARY] R20 physical-device UI root-cause closure, approved design fidelity, functional, security, payment, RTC and workstation-safe checks passed.'
exit 0
