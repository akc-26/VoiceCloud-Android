...
/**
 * Elevated command-center navigation with a dominant central Live action.
 * [sideDestinations] should be four items (two on each side of Live).
 */
@Composable
fun VCCommandBar(
    ...
    val liveScale by animateFloatAsState(
        ...
        animationSpec = if (motionEnabled) VoiceCloudMotion.micro() else androidx.compose.animation.core.snap(),
