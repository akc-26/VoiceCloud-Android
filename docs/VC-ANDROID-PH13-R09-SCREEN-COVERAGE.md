# VC-ANDROID-PH13-R09 Screen / Visual Coverage Inventory

Total named feature screens: **87**.

Every screen listed here is covered by the R09 premium visual-shell regression. The list is derived directly from the Kotlin source; it does not invent routes or features.
...
- `CreatorGiftsScreen`
- `CreatorPayoutsScreen`
- `CreatorPayoutDetailScreen`
